...
--
-- Host: localhost    Database: chardev_cataclysm
-- ------------------------------------------------------
...
--
-- Current Database: `chardev_cataclysm`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `chardev_cataclysm` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `chardev_cataclysm`;
...
CREATE TABLE `spelleffect` (
  ...
  `f27` int(11) DEFAULT '0' COMMENT '4.2\n',
  PRIMARY KEY (`ID`),
  KEY `Spell` (`SpellID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spellpower` (
  ...
  `f6` int(11) DEFAULT '0',
  `f7` int(11) DEFAULT '0',
  `f8` int(11) DEFAULT '0' COMMENT 'Added 4.3',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spellscaling` (
  ...
  `Coefficient1` float DEFAULT '0',
  `Coefficient2` float DEFAULT '0',
  `Coefficient3` float DEFAULT '0',
  `Dice1` float DEFAULT '0',
  `Dice2` float DEFAULT '0',
  `Dice3` float DEFAULT '0',
  `f12` float DEFAULT '0',
  `f13` int(11) DEFAULT '0',
  `f14` int(11) DEFAULT '0',
  `f15` float DEFAULT '0',
  `f16` int(11) DEFAULT '0' COMMENT 'Mainly 0, 80 for Deadly, Instant and Wound Poison',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spellvisual` (
  ...
  `f31` float DEFAULT '0',
  `f32` float DEFAULT '0',
  `f33` int(11) DEFAULT NULL COMMENT '4.10',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `talent` (
  ...
  `SpellID4` int(11) DEFAULT '0',
  `SpellID5` int(11) DEFAULT '0',
  `RequiredTalentID1` int(11) DEFAULT '0',
  `RequiredTalentID2` int(11) DEFAULT '0',
  `RequiredTalentID3` int(11) DEFAULT '0',
  `f13` int(11) DEFAULT '0',
  `f14` int(11) DEFAULT '0',
  `f15` int(11) DEFAULT '0',
  `f16` int(11) DEFAULT '0',
  `f17` int(11) DEFAULT '0',
  `PetMask0` int(11) DEFAULT '0',
  `PetMask1` int(11) DEFAULT '0',
  PRIMARY KEY (`ID`),
  KEY `TalentTree` (`TalentTabID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2011-12-30 17:21:53
