...
--
-- Host: 127.0.0.1    Database: chardev_user
-- ------------------------------------------------------
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `chardev_user` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
--
-- Table structure for table `chardev_character_old`
--

DROP TABLE IF EXISTS `chardev_character_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chardev_character_old` (
  `ID` int(11) NOT NULL DEFAULT '0',
  `UserID` int(11) NOT NULL,
  `Name` varchar(1024) CHARACTER SET utf8 DEFAULT NULL,
  `Description` varchar(16536) CHARACTER SET utf8 DEFAULT NULL,
...
--
-- Table structure for table `chardev_characters_mop`
--

DROP TABLE IF EXISTS `chardev_characters_mop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chardev_characters_mop` (
  `ID` int(11) NOT NULL DEFAULT '0',
  `UserID` int(11) NOT NULL,
  `Name` varchar(1024) CHARACTER SET utf8 DEFAULT NULL,
  `Description` varchar(16536) CHARACTER SET utf8 DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=153292 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
