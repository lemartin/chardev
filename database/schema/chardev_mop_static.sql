...
--
-- Host: 127.0.0.1    Database: chardev_mop_static
-- ------------------------------------------------------
...
--
-- Current Database: `chardev_mop_static`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `chardev_mop_static` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `chardev_base_stats_class_level` (
  ...
  `dodgePerAgi` double NOT NULL,
  `parryPerStr` double DEFAULT NULL,
...
--
-- Table structure for table `chardev_item_source`
--

DROP TABLE IF EXISTS `chardev_item_source`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chardev_item_source` (
  `ItemID` int(11) NOT NULL,
  `Type` int(11) NOT NULL,
  `SourceID` int(11) NOT NULL,
  PRIMARY KEY (`ItemID`,`Type`,`SourceID`),
  KEY `ItemID` (`ItemID`),
...
--
-- Table structure for table `chardev_quest`
--

DROP TABLE IF EXISTS `chardev_quest`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chardev_quest` (
  `ID` int(11) NOT NULL,
  `Title` mediumtext NOT NULL,
  `RequiredLevel` int(11) NOT NULL,
  `Level` int(11) NOT NULL,
  `Category` mediumtext NOT NULL,
  `SuggestedPartyMembers` int(11) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `chardev_spellitemenchantmentinfo`
--

DROP TABLE IF EXISTS `chardev_spellitemenchantmentinfo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chardev_spellitemenchantmentinfo` (
  `SpellItemEnchantmentID` int(11) NOT NULL,
  `DescriptionEN` mediumtext CHARACTER SET utf8 NOT NULL,
  `DescriptionFR` mediumtext CHARACTER SET utf8 NOT NULL,
  `DescriptionDE` mediumtext CHARACTER SET utf8 NOT NULL,
  `DescriptionES` mediumtext CHARACTER SET utf8 NOT NULL,
  `DescriptionRU` mediumtext CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`SpellItemEnchantmentID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
