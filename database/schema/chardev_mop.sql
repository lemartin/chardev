...
--
-- Host: 127.0.0.1    Database: chardev_mop
-- ------------------------------------------------------
...
--
-- Current Database: `chardev_mop`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `chardev_mop` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `chardev_itemset_stats` (
  ...
  KEY `MinItemLevel` (`MinItemLevel`),
  KEY `MaxItemLevel` (`MaxItemLevel`),
  KEY `MinRequiredCharacterLevel` (`MinRequiredCharacterLevel`),
  KEY `MaxRequiredCharacterLevel` (`MaxRequiredCharacterLevel`),
  KEY `MinQuality` (`MinQuality`),
  KEY `MaxQuality` (`MaxQuality`),
  KEY `ChrClassMask` (`ChrClassMask`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chrclasses` (
  ...
  `f16` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f17` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
...
CREATE TABLE `chrraces` (
  ...
  `NameInternal` text,
  `f13` int(11) DEFAULT '0',
  `Allegiance` int(11) DEFAULT '0' COMMENT '0 = Alliance\\n1 = Horde\\n2 = None',
  `Name` text,
  ...
  `f26` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f27` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f28` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f29` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f30` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f31` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f32` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f33` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f34` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
  `f35` int(11) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
...
CREATE TABLE `chrspecialization` (
  ...
  `Role` int(11) DEFAULT NULL COMMENT '0: Protection\n1: Heal\n2: Damage',
  `SpellIconID` int(11) DEFAULT NULL,
  `f10` int(11) DEFAULT NULL,
  `f11` int(11) DEFAULT NULL,
  `Name` varchar(2048) DEFAULT NULL,
  `Description` varchar(2048) DEFAULT NULL COMMENT 'Added btw 15640 & 15851',
...
CREATE TABLE `currencytypes` (
  ...
  `CurrencyCategoryID` int(11) DEFAULT NULL,
  `Name` text,
  `Icon` text,
  `f5` int(11) DEFAULT NULL,
  ...
  `WeeklyMaximum` int(11) DEFAULT NULL,
  `f10` int(11) DEFAULT NULL,
  `f11` int(11) DEFAULT NULL,
  `Description` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `gtoctbasehpbyclass`
--

DROP TABLE IF EXISTS `gtoctbasehpbyclass`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gtoctbasehpbyclass` (
  `ID` int(11) NOT NULL,
  `BaseHp` float DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `gtoctbasempbyclass`
--

DROP TABLE IF EXISTS `gtoctbasempbyclass`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gtoctbasempbyclass` (
  `ID` int(11) NOT NULL,
  `BaseMp` float DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `gtocthpperstamina`
--

DROP TABLE IF EXISTS `gtocthpperstamina`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gtocthpperstamina` (
  `Level` int(11) NOT NULL,
  `HpPerStamina` float DEFAULT NULL,
  PRIMARY KEY (`Level`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `gtresiliencedr`
--

DROP TABLE IF EXISTS `gtresiliencedr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gtresiliencedr` (
  `f1` int(11) NOT NULL,
  `f2` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_sparse` (
  ...
  `TypeMask5` int(11) DEFAULT '0',
  `TypeMask6` int(11) DEFAULT '0' COMMENT 'MoP',
...
CREATE TABLE `itemclass` (
  `ID` int(11) NOT NULL DEFAULT '0',
  `f2` int(11) DEFAULT '0',
  `f3` float DEFAULT NULL COMMENT 'Added 4.3',
  `Name` text,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `itemnamedescription`
--

DROP TABLE IF EXISTS `itemnamedescription`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `itemnamedescription` (
...
CREATE TABLE `itemspecoverride` (
  `ID` int(11) NOT NULL,
  `ItemID` int(11) NOT NULL,
  `ItemSpecGroupID` int(11) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `itemupgrade` (
  `ID` int(11) NOT NULL,
  `GroupID` int(11) DEFAULT NULL,
  `ItemLevelIncrease` int(11) DEFAULT NULL,
  `RequiredItemUpgradeID` int(11) DEFAULT NULL,
  `CurrencyID` int(11) DEFAULT NULL,
...
--
-- Table structure for table `questpoipoint`
--

DROP TABLE IF EXISTS `questpoipoint`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `questpoipoint` (
  `ID` int(11) NOT NULL,
  `f2` int(11) DEFAULT NULL,
  `f3` int(11) DEFAULT NULL,
  `f4` int(11) DEFAULT NULL,
...
CREATE TABLE `skilllineability` (
  ...
  `f11` int(11) DEFAULT '0',
  `f12` int(11) DEFAULT '0',
  `f13` varchar(45) DEFAULT NULL COMMENT 'MoP 15640',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spelleffect` (
  ...
  `EffectSpellRadiusID` int(11) DEFAULT '0',
  `LevelModifier` float DEFAULT '0',
  `f19` int(11) DEFAULT '0',
  `f20` int(11) DEFAULT '0',
  `f21` int(11) DEFAULT '0',
  `f22` int(11) DEFAULT '0' COMMENT 'MoP, Mask',
  `ProcSpellID` int(11) DEFAULT '0',
  `SpellScalingCoefficient` float DEFAULT '0' COMMENT 'MoP, Spell scaling?',
...
--
-- Table structure for table `spelleffectscaling`
--

DROP TABLE IF EXISTS `spelleffectscaling`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spelleffectscaling` (
  `ID` int(11) NOT NULL,
  `Coefficient` float DEFAULT NULL,
  `Dice` float DEFAULT NULL,
  `f4` float DEFAULT NULL,
  `SpellEffectID` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `SpellEffectID` (`SpellEffectID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spellmisc` (
  ...
  `Type11` int(11) NOT NULL,
  `Type12` int(11) NOT NULL,
...
CREATE TABLE `spellpower` (
  ...
  `f8` int(11) DEFAULT '0',
  `f9` int(11) DEFAULT '0',
  `Relative` float DEFAULT '0' COMMENT 'Added 4.3',
...
CREATE TABLE `spellradius` (
  ...
  `f3` int(11) DEFAULT '0',
  `MinRadius` float DEFAULT NULL COMMENT 'MoP\n',
  `f5` float DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spelltargetrestrictions` (
  ...
  `SpellID` int(11) DEFAULT '0',
  `f2` int(11) DEFAULT '0' COMMENT 'MoP\n',
  `Level` float DEFAULT '0' COMMENT 'MoP\n',
...
CREATE TABLE `talent` (
  ...
  `ReplacedSpellID` int(11) DEFAULT NULL COMMENT 'Unknown',
...
-- Dump completed on 2016-06-04 23:23:50
