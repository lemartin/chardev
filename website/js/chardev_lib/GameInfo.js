 ...
 * @returns {boolean}
 */
GameInfo.canDualWield = function(chrClassId)
{
 ...
 * @returns {boolean}
 */
GameInfo.canBlock = function(chrClassId)
{
 ...
 * @returns {boolean}
 */
GameInfo.canParry = function(chrClassId)
{
 ...
 * @returns {boolean}
 */
GameInfo.hasMana = function(chrClassId, shapeForm)
{
 ...
 * @returns {boolean}
 */
GameInfo.hasRage = function(chrClassId, shapeForm)
{
 ...
 * @returns {boolean}
 */
GameInfo.hasEnergy = function(chrClassId, shapeForm)
{
 ...
 * @returns {boolean}
 */
GameInfo.hasFocus = function(chrClassId, shapeForm) {
 ...
 * @returns {boolean}
 */
GameInfo.hasRunicPower = function(chrClassId, shapeForm ) {
 ...
 * @returns {boolean}
 */
GameInfo.couldDualWieldTwoHandedWeapons = function(chrClassId)
{
 ...
 * @returns {boolean}
 */
GameInfo.isWeaponSlot = function(slot, chrClassId)
{
 ...
 * @returns {number}
 */
GameInfo.getEnergyType = function( chrClassId, shapeForm )
{
 ...
 * @returns {number}
 */
GameInfo.getMatchingGemSubClasses = function( socketColor ) {
	if( socketColor == 1 ) {
		return 1<<6;
	}
 ...
 * @returns {number}
 */
GameInfo.getMaximumProfessionTier = function( skillLineId, level ) {
 ...
 * @returns {number}
 */
GameInfo.getMaximumProfessionLevel = function(skillLineId, level) {
 ...
 * @returns {boolean}
 */
GameInfo.isProfession = function(skillLineId ) {
	switch(skillLineId) {
	case 164:
	case 165:
	case 171:
