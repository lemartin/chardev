...
--
-- Temporary table structure for view `itemrandomproperties`
--

DROP TABLE IF EXISTS `itemrandomproperties`;
/*!50001 DROP VIEW IF EXISTS `itemrandomproperties`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `itemrandomproperties` (
  `ID` int(11),
  `InternalName` text,
  `SpellItemEnchantmentID1` int(11),
  `SpellItemEnchantmentID2` int(11),
  `SpellItemEnchantmentID3` int(11),
  `SpellItemEnchantmentID4` int(11),
  `SpellItemEnchantmentID5` int(11),
  `Name` text
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `itemrandomsuffix`
--

DROP TABLE IF EXISTS `itemrandomsuffix`;
/*!50001 DROP VIEW IF EXISTS `itemrandomsuffix`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `itemrandomsuffix` (
  `ID` int(11),
  `Name` text,
...
--
-- Final view structure for view `itemrandomproperties`
--

/*!50001 DROP TABLE IF EXISTS `itemrandomproperties`*/;
/*!50001 DROP VIEW IF EXISTS `itemrandomproperties`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `itemrandomproperties` AS select `chardev_cataclysm`.`itemrandomproperties`.`ID` AS `ID`,`chardev_cataclysm`.`itemrandomproperties`.`InternalName` AS `InternalName`,`chardev_cataclysm`.`itemrandomproperties`.`SpellItemEnchantmentID1` AS `SpellItemEnchantmentID1`,`chardev_cataclysm`.`itemrandomproperties`.`SpellItemEnchantmentID2` AS `SpellItemEnchantmentID2`,`chardev_cataclysm`.`itemrandomproperties`.`SpellItemEnchantmentID3` AS `SpellItemEnchantmentID3`,`chardev_cataclysm`.`itemrandomproperties`.`SpellItemEnchantmentID4` AS `SpellItemEnchantmentID4`,`chardev_cataclysm`.`itemrandomproperties`.`SpellItemEnchantmentID5` AS `SpellItemEnchantmentID5`,`chardev_cataclysm`.`itemrandomproperties`.`Name` AS `Name` from `chardev_cataclysm`.`itemrandomproperties` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `itemrandomsuffix`
--

/*!50001 DROP TABLE IF EXISTS `itemrandomsuffix`*/;
/*!50001 DROP VIEW IF EXISTS `itemrandomsuffix`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `itemrandomsuffix` AS select `chardev_cataclysm`.`itemrandomsuffix`.`ID` AS `ID`,`chardev_cataclysm`.`itemrandomsuffix`.`Name` AS `Name`,`chardev_cataclysm`.`itemrandomsuffix`.`InternalDescription` AS `InternalDescription`,`chardev_cataclysm`.`itemrandomsuffix`.`SpellItemEnchantmentID1` AS `SpellItemEnchantmentID1`,`chardev_cataclysm`.`itemrandomsuffix`.`SpellItemEnchantmentID2` AS `SpellItemEnchantmentID2`,`chardev_cataclysm`.`itemrandomsuffix`.`SpellItemEnchantmentID3` AS `SpellItemEnchantmentID3`,`chardev_cataclysm`.`itemrandomsuffix`.`SpellItemEnchantmentID4` AS `SpellItemEnchantmentID4`,`chardev_cataclysm`.`itemrandomsuffix`.`SpellItemEnchantmentID5` AS `SpellItemEnchantmentID5`,`chardev_cataclysm`.`itemrandomsuffix`.`Coefficient1` AS `Coefficient1`,`chardev_cataclysm`.`itemrandomsuffix`.`Coefficient2` AS `Coefficient2`,`chardev_cataclysm`.`itemrandomsuffix`.`Coefficient3` AS `Coefficient3`,`chardev_cataclysm`.`itemrandomsuffix`.`Coefficient4` AS `Coefficient4`,`chardev_cataclysm`.`itemrandomsuffix`.`Coefficient5` AS `Coefficient5` from `chardev_cataclysm`.`itemrandomsuffix` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2011-07-18 20:54:47
